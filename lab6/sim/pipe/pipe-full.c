...
int gen_f_pc()
{
    return (((((((mem_wb_curr->icode) == (I_ALU) || (mem_wb_curr->icode)
                 == (I_IADDL)) & ((ex_mem_curr->icode) == (I_JMP))) & !
            (ex_mem_curr->takebranch)) & ((ex_mem_curr->ifun) != 0)) & (
...
int gen_f_predPC()
{
    return ((((if_id_next->icode) == (I_JMP)) & ((if_id_next->ifun) == 0))
       ? (if_id_next->valc) : ((((if_id_curr->icode) == (I_NOP) || 
            (if_id_curr->icode) == (I_HALT) || (if_id_curr->icode) == 
            (I_RRMOVL) || (if_id_curr->icode) == (I_IRMOVL) || 
            (if_id_curr->icode) == (I_RMMOVL) || (if_id_curr->icode) == 
            (I_MRMOVL) || (if_id_curr->icode) == (I_JMP) || 
            (if_id_curr->icode) == (I_CALL) || (if_id_curr->icode) == 
            (I_RET) || (if_id_curr->icode) == (I_PUSHL) || 
            (if_id_curr->icode) == (I_POPL) || (if_id_curr->icode) == 
            (I_LEAVE)) & !(ex_mem_next->takebranch)) & ((if_id_next->icode)
           == (I_JMP))) ? (if_id_next->valp) : ((((if_id_curr->icode) == 
            (I_NOP) || (if_id_curr->icode) == (I_HALT) || 
            (if_id_curr->icode) == (I_RRMOVL) || (if_id_curr->icode) == 
            (I_IRMOVL) || (if_id_curr->icode) == (I_RMMOVL) || 
            (if_id_curr->icode) == (I_MRMOVL) || (if_id_curr->icode) == 
            (I_JMP) || (if_id_curr->icode) == (I_CALL) || 
            (if_id_curr->icode) == (I_RET) || (if_id_curr->icode) == 
            (I_PUSHL) || (if_id_curr->icode) == (I_POPL) || 
            (if_id_curr->icode) == (I_LEAVE)) & (ex_mem_next->takebranch))
         & ((if_id_next->icode) == (I_JMP))) ? (if_id_next->valc) : (((
            (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode) == 
            (I_IADDL)) & ((if_id_next->icode) == (I_CALL))) | ((((
                (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode) == 
                (I_IADDL)) & ((if_id_next->icode) == (I_JMP))) & (
              (if_id_next->valp) > (if_id_next->valc))) & (
            (if_id_next->ifun) != 0))) ? (if_id_next->valc) : 
      (if_id_next->valp));
}
...
int gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
        (I_MRMOVL) || (id_ex_curr->icode) == (I_ALU) || (id_ex_curr->icode)
         == (I_CALL) || (id_ex_curr->icode) == (I_IADDL) || 
        (id_ex_curr->icode) == (I_PUSHL) || (id_ex_curr->icode) == (I_RET)
         || (id_ex_curr->icode) == (I_POPL)) ? (id_ex_curr->valb) : (
        (id_ex_curr->icode) == (I_RRMOVL) || (id_ex_curr->icode) == 
        (I_IRMOVL) || (id_ex_curr->icode) == (I_JMP)) ? 0 : 0);
}
...
int gen_D_bubble()
{
    return ((((((((ex_mem_curr->icode) == (I_ALU) || (ex_mem_curr->icode)
                   == (I_IADDL)) & ((id_ex_curr->icode) == (I_JMP))) & !
              (ex_mem_next->takebranch)) & ((id_ex_curr->ifun) != 0)) & (
            (id_ex_curr->vala) > (id_ex_curr->valc))) | (((((
                  (ex_mem_curr->icode) == (I_ALU) || (ex_mem_curr->icode)
                   == (I_IADDL)) & ((id_ex_curr->icode) == (I_JMP))) & 
              (ex_mem_next->takebranch)) & ((id_ex_curr->ifun) != 0)) & (
            (id_ex_curr->vala) <= (id_ex_curr->valc)))) | (!(
          (id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          (I_POPL)) & ((I_RET) == (if_id_curr->icode) || (I_RET) == 
          (id_ex_curr->icode) || (I_RET) == (ex_mem_curr->icode))));
}
